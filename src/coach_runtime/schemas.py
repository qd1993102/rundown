...
def validate_training_framework(value: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "ability_summary": _mapping(item.get("ability_summary", {}), "ability_summary"),
        "goal_demand_summary": _mapping(item.get("goal_demand_summary", {}), "goal_demand_summary"),
        ...
        "weekly_principles": _mapping(item.get("weekly_principles", {}), "weekly_principles"),
